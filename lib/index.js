...
const {
  existingTopologyRoutePattern,
  listenerRoutePattern,
  publisherRoutePattern,
  workerRoutePattern,
} = require("./route-patterns");
...
const magicbus = {
  ...
  createPublisher: function (broker, configurator) {
    typeof broker === "object" || assert.fail("broker not provided");
    !configurator ||
      typeof configurator === "function" ||
      assert.fail("configurator must be a function");
  ...
  routePatterns: {
    existingTopology: existingTopologyRoutePattern,
    listener: listenerRoutePattern,
    publisher: publisherRoutePattern,
    worker: workerRoutePattern,
  },
};
