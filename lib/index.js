...
var PublisherConfigurator = require('./config/publisher-configurator');
var ConsumerConfigurator = require('./config/consumer-configurator');
var SubscriberConfigurator = require('./config/subscriber-configurator');
var BinderConfigurator = require('./config/binder-configurator');
...
module.exports = {
  ...
  createBinder: function(connectionInfo, configurator) {
    return new BinderConfigurator(connectionInfo, configurator).createBinder();
  },
