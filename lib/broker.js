...
var fixConnectionInfo = require('./util').fixConnectionInfo;
 ...
 */
function Broker(amqp, serviceDomainName, appName, connectionInfo) {
...
Broker.fixConnectionInfo = fixConnectionInfo;
