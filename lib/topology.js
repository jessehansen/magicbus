...
var Topology = function(connection, options, unhandledStrategies, log) {
...
Topology.prototype.createPrimitive = function(Primitive, primitiveType, options) {
  ...
  if(!promise) {
    this.promises[channelName] = promise = new Promise(function(resolve, reject) {
      ...
      var primitive = this.channels[channelName] = new Primitive(options, this.connection, this, this.log);
...
module.exports = function(connection, options, unhandledStrategies, log, exchangeFsm, queueFsm, defaultId) {
