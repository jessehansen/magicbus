...
/**
 * Creates an exchange machine instance
 * @param {Object} options - the options passed to exchangeFactory
 * @param {String} options.name - the name of the exchange
 * @param {String} options.type - the type of the exchange
 * @param {String} options.publishTimeout - how long to wait before timing out a publish (defaults to 0)
  ...
  const ExchangeMachine = machina.Fsm.extend({
    ...
    republish: function() {
      ...
      if (undelivered.length > 0) {
        // TODO: remove .bind once amqp/channel is module-ized
