 ...
 * @param {Function} channelFactory - factory function that takes a connection, whether the channel should be a confirmChannel, and the logger and returns a ChannelMachine
