...
Subscriber.prototype._handler = function Subscriber$handler(data, messageTypes, msg) {
  var self = this;
 ...
 */
Subscriber.prototype.purgeQueue = function Subscriber$getRoute() {
  return this._consumer.purgeQueue();
};
