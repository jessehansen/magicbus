...
class AckBatch {
   ...
   * @param {Function} resolver - function with signature function(op, data). op will be a string, either 'waiting', 'ack', 'nack', or 'reject'
   * @param {Object} logger - the current logger. Will be scoped into the 'batch' scope
   */
   ...
   * @returns {Object} object containing message (message with tag and status), ack (function), nack (function), and reject (function) properties
   */
  getMessageOps(tag) {
    let message = {
      tag: tag,
