const ConsumerTopology = require('../consumer/default-consumer-topology')
...
const ConsumerConfigurator = (defaultRouteName) => (broker) => {
...
module.exports = ConsumerConfigurator('receive')
module.exports.withDefaultRouteName = ConsumerConfigurator
