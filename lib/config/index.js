...
module.exports = function Configurator (logger, events) {
  ...
  function createPublisher (broker, configurator) {
    let params = getParams(PublisherConfiguration, configurator)
  ...
  function createConsumer (broker, configurator) {
    ...
    return Consumer(broker, params.envelope, params.pipeline, params.routeName, params.routePattern,
  ...
  function createSubscriber (broker, configurator) {
    ...
    if (!params.consumer) {
      params.consumer = Consumer(broker, params.envelope, params.pipeline, params.routeName, params.routePattern,
        params.logger, events)
    }
