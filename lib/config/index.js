 ...
 * @param {Object} logger - the default logger
 */
module.exports = function Configurator(logger) {
  /**
  ...
  function createTopology(connectionInfo, logger) {
    ...
    let connection = Connection(options, logger);
    let topology = Topology(connection, logger);
    return topology;
  }
  ...
  function createConsumer(broker, configurator) {
    ...
    return Consumer(broker, params.envelope, params.pipeline, params.routeName, params.routePattern, params.logger);
  };
  ...
  function createSubscriber(broker, configurator) {
    ...
    if (!params.consumer) {
      params.consumer = Consumer(broker, params.envelope, params.pipeline, params.routeName, params.routePattern, params.logger);
    }
    return Subscriber(params.consumer, params.eventDispatcher, params.logger);
  };
