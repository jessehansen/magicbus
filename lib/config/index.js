...
Configurator.prototype.createBroker = function Configurator$createBroker(serviceDomainName, appName, connectionInfo /*, configurator */) {
  return Broker(serviceDomainName, appName, connectionInfo, this._logger);
};
...
Configurator.prototype.createPublisher = function Configurator$createPublisher(broker, configurator) {
  ...
  return Publisher(broker, params.envelope, params.pipeline, params.routeName, params.routePattern, this._logger);
};
...
Configurator.prototype.createConsumer = function Configurator$createConsumer(broker, configurator) {
  ...
  return Consumer(broker, params.envelope, params.pipeline, params.routeName, params.routePattern, this._logger);
};
...
Configurator.prototype.createSubscriber = function Configurator$createSubscriber(broker, configurator) {
  ...
  if (!params.consumer) {
    params.consumer = Consumer(broker, params.envelope, params.pipeline, params.routeName, params.routePattern, this._logger);
  }
  return Subscriber(params.consumer, params.eventDispatcher, this._logger);
};
