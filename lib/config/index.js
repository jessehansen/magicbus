...
const loggerConfigurator = (logger) => {
   ...
   */
  const useLogger = (loggerOrFactoryFunction) => {
...
module.exports = function Configurator (logger, events) {
  ...
  function createPublisher (broker, configurator) {
    ...
    return publisherFactory(broker, params.envelope, params.pipeline, params.routeName, params.routePattern,
      params.logger)
  };
  ...
  function createConsumer (broker, configurator) {
    ...
    return consumerFactory(broker, params.envelope, params.pipeline, params.routeName, params.routePattern,
      params.logger, events)
  };
  ...
  function createSubscriber (broker, configurator) {
    ...
    if (!params.consumer) {
      params.consumer = consumerFactory(broker, params.envelope, params.pipeline, params.routeName, params.routePattern,
        params.logger, events)
    }
