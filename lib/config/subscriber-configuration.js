...
let WorkerRoutePattern = require('../route-patterns/worker-route-pattern')
...
module.exports = function SubscriberConfiguration () {
  let consumerFactory = function () {
    return null
  }
  let eventDispatcherFactory = function () {
    return EventDispatcher()
  }

  let envelopeFactory = function () {
    return new BasicEnvelope()
  }
  let pipelineFactory = function () {
    return ConsumerPipeline()
  }
  let routeNameFactory = function () {
    return 'subscribe'
  }
  let routePatternFactory = function () {
    return new WorkerRoutePattern()
  }
