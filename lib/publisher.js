...
Publisher.prototype.getPublishRoute = function(){
  var brokerRoute = this._broker.getRouteParams();
  brokerRoute.name = this._routeName || 'publish';
  brokerRoute.pattern = this._routePattern || new PublisherRoutePattern();
  return brokerRoute;
};

Publisher.prototype.getSendRoute = function(){
  var brokerRoute = this._broker.getRouteParams();
  brokerRoute.name = this._routeName || 'publish';
  brokerRoute.pattern = this._routePattern || new PublisherRoutePattern();
  return brokerRoute;
