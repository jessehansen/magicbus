...
module.exports = function Exchange(options, topology, publishLog, log) {
  ...
  function publish(message) {
    ...
    exLog.silly(`Publishing message (type: ${publishOptions.type} topic: ${effectiveKey}, sequence: ${message.sequenceNo}, correlation: ${publishOptions.correlationId}, replyTo: ${publishOptions.replyTo}) to ${type} exchange ${channelName} - ${connectionName}`);
