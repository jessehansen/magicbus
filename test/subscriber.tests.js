...
describe("Subscriber", () => {
  ...
  describe("#startSubscription", () => {
    ...
    it("should pass consumed events to the dispatcher", () => {
      ...
      return mockConsumer
        ._handler(payload, messageTypes, msg, mockActions)
        .then(() => {
    ...
    it(
      "should allow nacking the message " +
    ...
    it("should fail given no handler is registered for the message type", () => {
      subscriber.startSubscription();
      return expect(
        mockConsumer._handler(payload, messageTypes, msg)
    ...
    it("should fail given async handler fails", () => {
      ...
      subscriber.startSubscription();
      return expect(mockConsumer._handler(payload, messageTypes, msg))
