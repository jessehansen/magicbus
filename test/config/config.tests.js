...
describe("Configurator", () => {
  ...
  describe("#createBroker", () => {
    ...
    it("should create a broker with the default params", () => {
      let broker = configurator.createBroker(
        serviceDomainName,
        appName,
        connectionInfo
      );
  ...
  describe("#createPublisher", () => {
    ...
    it("should allow caller to override implementations", () => {
      let publisher = configurator.createPublisher(broker, (cfg) =>
        cfg
          .useEnvelope({})
          .useSerializer({})
  ...
  describe("#createConsumer", () => {
    ...
    it("should allow caller to override implementations", () => {
      let consumer = configurator.createConsumer(broker, (cfg) =>
        cfg
          .useEnvelope({})
          .useSerializer({})
          .usePipeline({ useLogger: () => {} })
  ...
  describe("#createSubscriber", () => {
    ...
    it("should allow caller to override consumer implementations", () => {
      let subscriber = configurator.createSubscriber(broker, (cfg) =>
        cfg
          .useEnvelope({})
          .useSerializer({})
          .usePipeline({ useLogger: () => {} })
    ...
    it("should allow caller to override the consumer", () => {
      let myConsumer = {};
      let subscriber = configurator.createSubscriber((cfg) =>
    ...
    it("should allow caller to override the consumer using a factory function", () => {
      let myConsumer = {};
      let subscriber = configurator.createSubscriber((cfg) =>
        cfg.useConsumerFactory(() => myConsumer)
      );
    ...
    it("should allow caller to override the event dispatcher", () => {
      ...
      let subscriber = configurator.createSubscriber(broker, (cfg) =>
        cfg.useEventDispatcher(myEventDispatcher)
      );
    ...
    it("should allow caller to override the event dispatcher using a factory function", () => {
      let myEventDispatcher = {};
      let subscriber = configurator.createSubscriber(broker, (cfg) =>
        cfg.useEventDispatcherFactory(() => myEventDispatcher)
      );
